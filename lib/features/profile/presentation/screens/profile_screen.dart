...
class ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> fetchPlayer() async {
    try {
      player =  await UseCaseProvider.getUseCase<GetPlayer>().call(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                    ...
                    SizedBox(
                      ...
                      child: ClipRRect(
                        ...
                        child: player!.avatar.path == ''
                            ...
                            : Image.network(player!.avatar.path),
                      ),
                    ),
                    Positioned(
                      bottom: 0,
                ...
                InformationMenu(
                    textContent: player!.phone,
                    icon: "phone"),
                InformationMenu(
                    textContent: "District ${player!.location.district}, ${player!.location.city} City",
                    icon: "location"),
                InformationMenu(
                    textContent: player!.dob,
                    icon: "dob"),
                const Divider(),
                InformationMenu(
