...
import 'package:sportifind/features/stadium/presentations/screens/stadium_owner/statistic/week_navigator.dart';
import 'package:sportifind/features/stadium/presentations/widgets/statistic/bar_chart.dart';
import 'package:sportifind/features/stadium/presentations/widgets/statistic/line_chart_card.dart';
import 'package:sportifind/features/stadium/presentations/widgets/statistic/statistic_card.dart';
...
class StadiumStatisticScreen extends StatefulWidget {
  ...
  @override
  StadiumStatisticScreenState createState() => StadiumStatisticScreenState();
}

int status = 0;

class StadiumStatisticScreenState extends State<StadiumStatisticScreen> {
  StatisticUtil statisticService = StatisticUtil();

  bool isWeekly = true;
  List<double> weeklySummary = [];

  late Map<String, List<MatchEntity>> matchesMap = {};
  ...
  Future<void> _loadWeeklySummary(int weekNumber) async {
    ...
    try {
      ...
      Map<String, List<MatchEntity>> currentMatchesMap =
      ...
      Map<String, List<MatchEntity>> previousMatchesMap =
